        ...
        async function init() {
            try {
                ...
                if (user) {
                    ...
                    console.log('User email:', email, 'Is admin:', ADMIN_EMAILS.some(e => e.toLowerCase() === email));
                }
            } catch (e) {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white border rounded-2xl p-6">
                    ...
                    <div className="space-y-3">
                        ...
                        <Link href="/portal/applications" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <Link href="/portal/documents" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
