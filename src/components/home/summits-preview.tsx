            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {summits.map((summit, index) => (
                        <Link key={index} href={`/summits/${summit.city.toLowerCase().split(',')[0].trim()}`} className="group block relative overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
